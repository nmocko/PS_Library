  ...
  <div class="w3-container w3-bar w3-light-grey">
    ...
    <div class="w3-hide-medium w3-hide-small">
      ...
      <!-- <form style="float: right; width: 30%;" >
        <input type="text" style="width: 34%; float: left;" class="w3-bar-item w3-round-large w3-border w3-border-black w3-input" placeholder="Login"></i>
        <input type="password" style="width: 34%; float: left;" class="w3-bar-item w3-round-large w3-border w3-border-black w3-input" placeholder="Haslo" >
        <a href="#" id="login" style="width: 30%; float: right" class="w3-bar-item w3-button w3-round-large w3-border w3-border-black w3-white">Zaloguj</a> 
      </form> -->
    ...
    <div class="w3-hide-large">
      ...
      <!-- <div class=" w3-dropdown-hover w3-block">
        <button class="w3-button w3-block"><i class="fa fa-search"></i></button>
        <div class="w3-dropdown-content w3-bar-block" style="width: 95%;">
          <input href="#"  class="w3-bar-item w3-border w3-border-black w3-input" placeholder="Login"></i>
          <input href="#" type="password" class="w3-bar-item w3-border w3-border-black w3-input" placeholder="Haslo" >
          <a href="#" id="login" class="w3-bar-item w3-button  w3-border w3-border-black w3-white">Zaloguj</a> 
        </div>
      </div> -->
...
<div class="w3-row w3-container" id='acc' style="width: 75%; margin-left: auto; margin-right: auto;">
  ...
  <div class="w3-row w3-container" id='accordion' style="width: 75%; margin-left: auto; margin-right: auto;">` )
    ...
    <!-- <script type="text/javascript" src="biblioteka.cjs"></script> -->
...
function requestListener(request, response) {
	...
	if (url.pathname == '/submit') { // Processing the form content, if the relative URL is '/submit'
		...
		if (request.method == 'GET') {
			const myArray = url.searchParams.get('name').split(" ");
	...
	else if (url.pathname == '/catbooks.gif') {
